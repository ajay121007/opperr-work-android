...
class PayStubsAdapter(
    private val _context: Context,
    private val _listDataHeader: ArrayList<String>,
    ...
    override fun getChildView(
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.item_time_sheet, null)
        }
        val txtListChild = convertView!!.findViewById<View>(R.id.btn_month) as AppCompatButton
