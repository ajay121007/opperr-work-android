 ...
 */
class AdminstrativeAdapter(val mContext: Context, var mList: List<String>, var mProductClickListener: ProductClickListener) : RecyclerView.Adapter<AdminstrativeAdapter.DashBoardViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DashBoardViewHolder {
        val viewHolder = LayoutInflater.from(parent.context).inflate(R.layout.item_adminstrative_menu, parent, false)
