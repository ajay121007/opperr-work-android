 ...
 */
class OperationAdapter(val mContext: Context, var mList: List<String>, var mProductClickListener: ProductClickListener) : RecyclerView.Adapter<OperationAdapter.DashBoardViewHolder>() {
