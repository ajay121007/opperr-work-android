...
class Data {
    ...
    var isChangeStatusNotification: Any? = null
    @SerializedName("isEmailNotification")
    var isEmailNotification: Any? = null
    @SerializedName("isIpHourlyRestricted")
    var isIpHourlyRestricted: Any? = null
    @SerializedName("isIpRestricted")
    var isIpRestricted: Any? = null
    @SerializedName("isOverrideOTLimit")
    var isOverrideOTLimit: Any? = null
    @SerializedName("isSMSNotification")
    var isSMSNotification: Any? = null
    ...
    var listIpHourlyRestricted: Any? = null
    @SerializedName("listIpRestricted")
    var listIpRestricted: Any? = null
